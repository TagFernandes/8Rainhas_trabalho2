...
TEST_CASE("solucoes invalidas para o problema", "[rainhas]") {
    ...
    REQUIRE(verifica_solucao_8_rainhas("teste_30.txt") == 0);
}
...
TEST_CASE("solucoes validas para o problema", "[rainhas]") {
    ...
    REQUIRE(verifica_solucao_8_rainhas("teste_26.txt") == 1);
    REQUIRE(verifica_solucao_8_rainhas("teste_27.txt") == 1);
    REQUIRE(verifica_solucao_8_rainhas("teste_28.txt") == 1);
    REQUIRE(verifica_solucao_8_rainhas("teste_28.txt") == 1);
}
...
TEST_CASE("matriz invalida para o problema", "[rainhas]") {
    ...
    REQUIRE(verifica_solucao_8_rainhas("teste_19.txt") == -1);
    REQUIRE(verifica_solucao_8_rainhas("teste_20.txt") == -1);
    REQUIRE(verifica_solucao_8_rainhas("teste_21.txt") == -1);
    REQUIRE(verifica_solucao_8_rainhas("teste_22.txt") == -1);
    REQUIRE(verifica_solucao_8_rainhas("teste_23.txt") == -1);
    REQUIRE(verifica_solucao_8_rainhas("teste_24.txt") == -1);
}
